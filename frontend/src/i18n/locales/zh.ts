export default {
  ...
  customPage: {
    ...
    tutorialAssetUploadSuccess: '资源上传成功，已插入编辑器',
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_PURCHASE_LIMIT_EXCEEDED: '该套餐已达到您的限购次数',
    ...
    planCard: {
      ...
      unlimited: '无限制',
      purchaseLimit: '限购',
      purchaseLimitValue: '每人限购 {count} 次',
      models: '模型',
    },
    days: '天',
    months: '个月',
    ...
    admin: {
      ...
      purchaseLimit: '限购次数',
      purchaseLimitRequired: '限购次数不能小于 0',
      purchaseLimitValue: '限购 {count} 次',
