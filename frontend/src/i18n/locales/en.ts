export default {
  ...
  customPage: {
    ...
    tutorialAssetUploadSuccess: 'Asset uploaded and inserted into editor',
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_PURCHASE_LIMIT_EXCEEDED: 'You have reached the purchase limit for this plan.',
    ...
    planCard: {
      ...
      unlimited: 'Unlimited',
      purchaseLimit: 'Limit',
      purchaseLimitValue: '{count} purchases per user',
      models: 'Models',
    },
    days: 'days',
    months: 'months',
    ...
    admin: {
      ...
      purchaseLimitRequired: 'Purchase limit must be greater than or equal to 0',
      purchaseLimitValue: 'Limit {count}',
