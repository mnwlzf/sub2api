export default {
    ...
    usageMonitor: {
      ...
      week: '周',
      month: '月',
      userFilter: '搜索用户并添加对比',
      allUsers: '全部用户',
      topUsers: '用户对比',
      models: '模型明细',
      modelTrend: '模型用量趋势',
      modelTrendHint: '按当前粒度展示模型随时间变化的实际消费',
      groupTrend: '分组监控',
      groupTrendHint: '按当前粒度对比各分组随时间变化的用量',
      topGroups: '分组排行',
      totalCost: '总消耗',
      noData: '暂无监控数据',
      lastHour: '展示最近 1 小时，按分钟聚合',
      last24h: '展示最近 24 小时',
    ...
    scheduledJobs: {
      title: '计划任务',
      description: '管理后台自动任务、执行记录和手动触发',
      create: '创建任务',
      runNow: '立即运行',
      logs: '执行记录',
      empty: '暂无计划任务',
      typeAsName: '任务类型会作为默认名称显示',
      retentionLimit: '保留记录数',
      sourceGroup: '源分组',
      selectSourceGroup: '选择源分组',
      targetGroups: '目标分组',
      noTargetGroups: '暂无可选目标分组',
      accountNameContains: '账号名包含',
      accountNameContainsHint: '仅同步名称包含该文本的账号',
      ratioMappingRules: '倍率映射规则',
      ratioMappingRulesHint: '按 Codex 倍率选择目标模型',
      addRatioRule: '添加规则',
      ratio: '倍率',
      targetModel: '目标模型',
      modelMapping: '模型映射',
      modelMappingHint: '请求模型到上游模型的映射',
      addMapping: '添加映射',
      requestModel: '请求模型',
      upstreamModel: '上游模型',
      payloadJson: 'Payload JSON',
      viewRatioTrend: '查看倍率趋势',
      noLogs: '暂无执行记录',
      ratioTrendTitle: '倍率趋势',
      ratioTrendGroup: '分组',
      ratioTrendWindow: '窗口',
      ratioTrendLatest: '最新倍率',
      lastThreeDays: '最近 3 天',
      codexRatio: 'Codex 倍率',
      invalidCron: 'Cron 表达式无效',
      plusGroupTargetConfirm: '目标分组包含 Plus 分组，确定继续？',
      sourceGroupRequired: '请选择源分组',
      targetGroupsRequired: '请选择目标分组',
      modelMappingRequired: '请至少添加一条模型映射',
      accountNameContainsRequired: '请填写账号名包含条件',
      ratioRulesRequired: '请至少添加一条倍率规则',
      runTriggered: '任务已触发',
      triggerManual: '手动',
      triggerScheduled: '定时',
      syncResult: '同步 {created} 个账号，跳过 {skipped} 个',
      openAIModelMappingResult: '已更新 {accounts} 个 OpenAI OAuth 账号',
      relayRatioResult: '当前倍率 {ratio}',
      relayRatioMappingResult: '当前倍率 {ratio}，匹配模型 {model}',
      relayRatioNoRuleResult: '当前倍率 {ratio}，未命中规则',
      columns: {
        type: '类型',
        nextRun: '下次运行',
        lastRun: '上次运行'
      ...
      types: {
        ...
        sync_codex_free_group_accounts: '同步 Codex 免费分组账号',
        cleanup_error_accounts: '清理异常账号',
        update_openai_oauth_model_mapping: '更新 OpenAI OAuth 模型映射',
        update_openai_oauth_shared_model_mapping: '更新共享 OpenAI OAuth 模型映射',
        update_openai_oauth_exclusive_model_mapping: '更新独享 OpenAI OAuth 模型映射',
        track_relay_codex_group_ratio: '跟踪 Relay Codex 分组倍率'
      }
    },
