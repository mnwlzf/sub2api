export default {
    ...
    usageMonitor: {
      ...
      week: 'Week',
      month: 'Month',
      userFilter: 'Search and add users',
      allUsers: 'All Users',
      topUsers: 'User Compare',
      models: 'Model Breakdown',
      modelTrend: 'Model Usage Trend',
      modelTrendHint: 'Actual model spend over time using the current granularity',
      groupTrend: 'Group Monitor',
      groupTrendHint: 'Compare group usage over time using the current granularity',
      topGroups: 'Top Groups',
      totalCost: 'Total Cost',
      noData: 'No monitor data',
      lastHour: 'Showing the last hour, grouped by minute',
    ...
    scheduledJobs: {
      ...
      description: 'Manage admin automation tasks, run history, and manual triggers',
      create: 'Create Job',
      runNow: 'Run Now',
      logs: 'Run Logs',
      empty: 'No scheduled jobs',
      typeAsName: 'The job type is used as the default display name',
      retentionLimit: 'Retention Limit',
      sourceGroup: 'Source Group',
      selectSourceGroup: 'Select source group',
      targetGroups: 'Target Groups',
      noTargetGroups: 'No target groups available',
      accountNameContains: 'Account Name Contains',
      accountNameContainsHint: 'Only sync accounts whose name contains this text',
      ratioMappingRules: 'Ratio Mapping Rules',
      ratioMappingRulesHint: 'Choose target models by Codex ratio',
      addRatioRule: 'Add Rule',
      ratio: 'Ratio',
      targetModel: 'Target Model',
      modelMapping: 'Model Mapping',
      modelMappingHint: 'Map request models to upstream models',
      addMapping: 'Add Mapping',
      requestModel: 'Request Model',
      upstreamModel: 'Upstream Model',
      payloadJson: 'Payload JSON',
      viewRatioTrend: 'View Ratio Trend',
      noLogs: 'No run logs',
      ratioTrendTitle: 'Ratio Trend',
      ratioTrendGroup: 'Group',
      ratioTrendWindow: 'Window',
      ratioTrendLatest: 'Latest Ratio',
      lastThreeDays: 'Last 3 Days',
      codexRatio: 'Codex Ratio',
      invalidCron: 'Invalid cron expression',
      plusGroupTargetConfirm: 'Target groups include a Plus group. Continue?',
      sourceGroupRequired: 'Select a source group',
      targetGroupsRequired: 'Select at least one target group',
      modelMappingRequired: 'Add at least one model mapping',
      accountNameContainsRequired: 'Enter the account name filter',
      ratioRulesRequired: 'Add at least one ratio rule',
      runTriggered: 'Job triggered',
      triggerManual: 'Manual',
      triggerScheduled: 'Scheduled',
      syncResult: 'Synced {created} accounts, skipped {skipped}',
      openAIModelMappingResult: 'Updated {accounts} OpenAI OAuth accounts',
      relayRatioResult: 'Current ratio {ratio}',
      relayRatioMappingResult: 'Current ratio {ratio}, matched model {model}',
      relayRatioNoRuleResult: 'Current ratio {ratio}, no rule matched',
      columns: {
        type: 'Type',
        nextRun: 'Next Run',
        lastRun: 'Last Run'
      ...
      types: {
        ...
        update_openai_oauth_shared_model_mapping: 'Update Shared OpenAI OAuth Model Mapping',
        update_openai_oauth_exclusive_model_mapping: 'Update Exclusive OpenAI OAuth Model Mapping',
        track_relay_codex_group_ratio: 'Track Relay Codex Group Ratio'
      }
    },
