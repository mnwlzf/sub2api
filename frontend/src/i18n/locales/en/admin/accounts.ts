export default {
    accounts: {
      ...
      columns: {
        ...
        poolUpstreamInfo: 'Upstream Info',
        weight: 'Weight',
      ...
      poolUpstream: {
        platform: 'Pool Upstream Platform',
        platformHint: 'Declare the upstream service type to enable information probes; only available for pool-mode API key accounts. Disabling pool mode saves the default.',
        platformDefault: 'Default (no probe)',
        platformSub2api: 'Sub2API',
        platformChatgpt2api: 'ChatGPT2API (OpenAI only)',
        features: 'Probe Features',
        featuresHint: 'Choose which upstream information to refresh periodically.',
        feature_balance: 'Balance (GET /v1/usage, USD)',
        feature_account_count: 'Normal accounts (accounts.active)',
        feature_image_quota: 'Known image quota (total_quota)',
        manualRefresh: 'Refresh upstream info now',
        notProbed: 'Not probed',
        stale: 'Stale',
        unsupported: 'Unsupported',
        failed: 'Failed',
        amount_wallet: 'Wallet balance: {value}',
        amount_quota: 'Remaining quota: {value}',
        amount_subscription: 'Subscription remaining: {value}',
        accountsActive: 'Normal accounts: {value}',
        totalQuota: 'Known image quota: {value}',
        unlimitedQuota: 'Unlimited-quota accounts: {value}',
        unknownQuota: 'Unknown-quota accounts: {value}',
        updatedAt: 'Updated: {value}',
        nextProbeAt: 'Next probe: {value}',
        probeFailed: 'Failed to refresh pool upstream info',
        errors: {
          request_failed: 'Request failed',
          empty_response: 'Empty response',
          response_read_failed: 'Failed to read the response',
          response_too_large: 'Response exceeded the size limit',
          invalid_response: 'Response format was not recognized',
          invalid_base_url: 'Invalid upstream base URL',
          missing_api_key: 'Missing API key',
          proxy_unavailable: 'Proxy unavailable',
          transport_unavailable: 'Probe transport unavailable',
          request_build_failed: 'Failed to build the request',
          unauthorized: 'Upstream authentication failed (401)',
          forbidden: 'Upstream denied access (403)',
          http_error: 'Upstream returned an error',
          unsupported: 'Upstream does not support this probe',
