...
func provideCleanup(
	...
	adminScheduledJobRunner *service.AdminScheduledJobRunnerService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"AdminScheduledJobRunnerService", func() error {
				if adminScheduledJobRunner != nil {
					adminScheduledJobRunner.Stop()
				}
				return nil
			}},
