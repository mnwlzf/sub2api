...
func init() {
	...
	// subscriptionplanDescPurchaseLimit is the schema descriptor for purchase_limit field.
	subscriptionplanDescPurchaseLimit := subscriptionplanFields[9].Descriptor()
	// subscriptionplan.DefaultPurchaseLimit holds the default value on creation for the purchase_limit field.
	subscriptionplan.DefaultPurchaseLimit = subscriptionplanDescPurchaseLimit.Default.(int)
