...
type UsageLogRepository interface {
	...
	GetUsageCostMonitor(ctx context.Context, startTime, endTime time.Time, granularity, timezone string, userID int64, limit int) (*usagestats.UsageCostMonitorData, error)
